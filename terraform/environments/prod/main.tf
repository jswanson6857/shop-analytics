...
terraform {
  ...
  # Using Terraform Cloud backend - configure your organization name
  backend "remote" {
    organization = "YOUR-ORG-NAME"  # UPDATE THIS in your repo!
  ...
  # OR use local backend (comment out 'remote' above and uncomment this):
  # backend "local" {
  #   path = "terraform.tfstate"
  # }
}

# Provider is now in provider.tf
