...
terraform {
  ...
  # =============================================================================
  # State persists in S3 - prevents duplicate resources on every deploy!
  # 
  # BEFORE FIRST DEPLOY:
  # 1. Run bootstrap to create bucket
  # 2. Replace BUCKET_NAME_FROM_BOOTSTRAP with actual bucket name
  # 3. Push to deploy
